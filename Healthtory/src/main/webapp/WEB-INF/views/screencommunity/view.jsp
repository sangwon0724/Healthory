...
%>
<%
	ScreenCommunityDAO dao=new ScreenCommunityDAO();//몸짱 게시판용으로 수정
	ScreenCommunityVO vo=new  ScreenCommunityVO();//몸짱 게시판용으로 수정
	
	dao.setoneScreenCommunity(no);
	vo=dao.list.get(0);
%>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
	<title><%= vo.getTitle() %> | Healthtory</title>
