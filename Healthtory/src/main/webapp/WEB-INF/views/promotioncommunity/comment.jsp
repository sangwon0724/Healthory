...
<head>
	...
	<title>동아리 홍보 게시판 댓글 | Healthory</title>
</head>
<body>
...
<% } %>
	<!-- 반복 시작할 곳 -->
		<%
		PromotionCommentDAO dao = new PromotionCommentDAO();
		PromotionCommentVO vo = new PromotionCommentVO();
		
		dao.setPromotionCommunityPromotionComment(Integer.parseInt((request.getParameter("no"))));
		if(dao.list.size()==0){
			%>
