...
<head>
<meta charset="UTF-8">
<title>동아리 홍보 게시판 | Healthory</title>
...
<body>
	...
	%>
		<%--DAO, VO 설정 시작 --%>
			<%
				PromotionCommunityDAO dao = new PromotionCommunityDAO();//수정하기
	            PromotionCommunityVO vo = new PromotionCommunityVO();//수정하기
